    ...
    <div class="container" style="max-width: 600px;">
        ...
        <div class="card shadow-lg border-0">
            <div class="card-header bg-info text-white">
                <h3 class="mb-0"><i class="fas fa-calculator mr-2"></i>Formulario de Notas</h3>
            </div>
            
            <div class="card-body">
                <form action="resultado5.jsp" method="post">
                    <!-- Campo Nota 1 -->
                    <div class="form-group">
                        <label class="h5 text-secondary">Nota 1</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-light border-0"><i class="fas fa-edit text-info"></i></span>
                            </div>
                    ...
                    <!-- Boton de calcular -->
                    <button type="submit" class="btn btn-info btn-lg btn-block shadow-sm py-3">
